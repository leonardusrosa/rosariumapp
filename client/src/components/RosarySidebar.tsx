            ...
            {sections.map((section) => (
              ...
              >
                <div className="flex items-center gap-3 w-full min-w-0">
                  {section.icon === 'custom-initium' ? (
                    <svg 
                      className="w-5 h-5 flex-shrink-0 text-byzantine-gold sacred-icon-hover transition-all duration-300" 
                      viewBox="0 0 512 512" 
                      fill="currentColor" 
                  ...
                  ) : section.icon === 'custom-angel' ? (
                    <svg 
                      className="w-5 h-5 text-byzantine-gold sacred-icon-hover transition-all duration-300" 
                      viewBox="0 0 512 512" 
                      fill="currentColor" 
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  ) : section.icon === 'custom-gloria-patri' ? (
                    <svg 
                      className="w-5 h-5 text-byzantine-gold sacred-icon-hover transition-all duration-300" 
                      viewBox="0 0 512 512" 
                      fill="currentColor" 
                  ...
                  ) : section.icon === 'custom-signum-crucis' ? (
                    <svg 
                      className="w-5 h-5 text-byzantine-gold sacred-icon-hover transition-all duration-300" 
                      viewBox="0 0 60 60" 
                      fill="currentColor" 
                    ...
                    <i className={`${section.icon} flex-shrink-0 text-byzantine-gold text-lg sacred-icon-hover`} />
                  )}
                  ...
                  {section.id === mystery && (
                    <div className="absolute top-2 right-2 w-6 h-6 rounded-full bg-[var(--ancient-gold)] flex items-center justify-center animate-pulse-gentle">
          ...
          <div className="mt-8 pt-6 border-t border-[var(--byzantine-gold-alpha)]">
            ...
            <div className="text-center">
              ...
              <div className="w-8 h-8 mx-auto mt-3 rounded-full bg-gradient-to-r from-[var(--byzantine-gold)] to-[var(--byzantine-gold-alpha)] flex items-center justify-center">
                {sections.find(s => s.id === mystery)?.icon === 'custom-initium' ? (
                  <svg 
                    className="w-4 h-4 text-[var(--cathedral-void)]" 
                    viewBox="0 0 512 512" 
                    fill="currentColor" 
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                ) : sections.find(s => s.id === mystery)?.icon === 'custom-gaudiosa' ? (
                  <svg 
                    className="w-4 h-4 text-[var(--cathedral-void)]" 
                    viewBox="0 0 512 512" 
                    fill="currentColor" 
                ...
                ) : sections.find(s => s.id === mystery)?.icon === 'custom-dolorosa' ? (
                  <svg 
                    className="w-4 h-4 text-[var(--cathedral-void)]" 
                    viewBox="0 0 480 480" 
                    fill="currentColor" 
                ...
                ) : sections.find(s => s.id === mystery)?.icon === 'custom-gloriosa' ? (
                  <svg 
                    className="w-4 h-4 text-[var(--cathedral-void)]" 
                    viewBox="0 0 24 24" 
                    fill="none" 
                ...
                ) : sections.find(s => s.id === mystery)?.icon === 'custom-ultima' ? (
                  <svg 
                    className="w-4 h-4 text-[var(--cathedral-void)]" 
                    viewBox="0 0 440 440" 
                    fill="currentColor" 
