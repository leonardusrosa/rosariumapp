...
export default function PrayerContent({ 
  ...
  const renderCustomPrayerCard = (prayer: { id: number; title: string; content: string; section: string }) => (
    <Card key={`custom-${prayer.id}`} className="sacred-content-card rounded-2xl sacred-border animate-fade-in-up transition-all duration-700 ease-in-out">
              ...
              {content.sections[currentSubSection] && (
                <>
                  ...
                  {isMysterySection && (content.sections[currentSubSection] as any).prayers && (content.sections[currentSubSection] as any).prayers.map((prayer: any, prayerIndex: number) => (
                    <Card key={prayerIndex} className="sacred-content-card rounded-2xl sacred-border animate-fade-in-up transition-all duration-700 ease-in-out">
                      <CardContent className="p-8">
                        <div className="text-center mb-8">
                          <h2 className="font-cinzel text-2xl font-medium text-ancient-gold sacred-header-glow mb-3">
                ...
                <div key={index}>
                  ...
                  {prayerSection.title === "Offertorium Rosarii" && intentions.length > 0 && (
                    <Card className="sacred-content-card rounded-2xl sacred-border mt-6">
                      <CardContent className="p-8">
                        <h3 className="font-cinzel text-xl font-medium text-ancient-gold sacred-header-glow mb-6 text-center flex items-center justify-center">
                          <svg 
